...
if (isset($_POST['updateProduct'])) {
    ...
    if (empty($_POST["urunadi"])) {
        ...
        $postQuery = "UPDATE viento_urunler SET urunler_kod =?, urunler_isim =?, urunler_resim =? , urunler_stok =?,urunler_sonfiyat =?, urunler_kdv =?, urunler_anakategori =?, urunler_altkategori =?, urunler_aciklama =? WHERE urunler_kod = ?";
        $postStmt = $link->prepare($postQuery);
        //bind paramaters
        $rc = $postStmt->bind_param('ssssssssss', $urunler_kod, $urunler_isim, $urunler_resim, $urunler_stok, $urunler_sonfiyat, $urunler_kdv, $urunler_anakategori, $urunler_altkategori, $urunler_aciklama, $update);
        $postStmt->execute();
                        ...
                        <div id="addproduct-accordion" class="custom-accordion">
                            <div class="card">
                                ...
                                <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                                    ...
                                    $update = $_GET['update'];
                                    $ret = "SELECT * FROM  viento_urunler WHERE urunler_kod = '$update' ";
                                        ...
                                        <div class="p-4 border-top">
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="urunadi" name="urunadi" placeholder="Ürün Adını Girin" type="text" class="form-control" value="<?php echo $prod->urunler_isim; ?>">
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="urunkodu" name="urunkodu" value="<?php echo $prod->urunler_kod; ?>" class="form-control" value="" readonly>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" data-trigger name="urunkdv" id="urunkdv" onchange="calculateSalePrice()">
                                                                <?php
                                                                if ($prod->urunler_kdv == 1) {
                                                                    echo '<option value="1">Tevfikatlı %1</option>';
                                                                    echo '<option value="8">%8</option>';
                                                                    echo '<option value="18">%18</option>';
                                                                } else if ($prod->urunler_kdv == 8) {
                                                                    echo '<option value="8">%8</option>';
                                                                    echo '<option value="1">Tevfikatlı %1</option>';
                                                                    echo '<option value="18">%18</option>';
                                                                } else if ($prod->urunler_kdv == 18) {
                                                                    echo '<option value="18">18</option>';
                                                                    echo '<option value="1">Tevfikatlı%1</option>';
                                                                    echo '<option value="8">%8</option>';
                                                                }
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="urunstok" name="urunstok" placeholder="Stok Adetini Girin" type="number" class="form-control" value="<?php echo $prod->urunler_stok; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                ...
                                                -->
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input id="urunsonfiyat" name="urunsonfiyat" placeholder="Satış Fiyatı" value="<?php echo $prod->urunler_sonfiyat; ?>" type="number" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <input type="file" name="urunler_resim" id="urunler_resim" class="btn btn-outline-success form-control" value="<?php echo $prod->urunler_resim; ?>">
                                                </div>
                                                <br>
                                                <div class="mb-0">
                                                    <label class="form-label" for="urunaciklama">Ürün Açıklaması</label>
                                                    <textarea class="form-control" id="urunaciklama" name="urunaciklama" placeholder="Açıklama Girin" rows="4"><?php echo $prod->urunler_aciklama; ?></textarea>
                                                </div>
                                                <br>
                                                <div class="row mb-4">
                                                    <div class="col text-end">
                                                        ...
                                                        <input type="submit" name="updateProduct" value="Ürünü Düzenle" class="btn btn-success" value="<?php echo $prod->urunler_aciklama; ?>">
                                                    </div> <!-- end col -->
                                                </div> <!-- end row-->
                                            </form>
                                        </div>
