                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <!-- Ürün Ekle -->
                            <li class="nav-item">
                                <a class="nav-link dropdown-toggle arrow-none" href="ecommerce-add-product.php" id="topnav-dashboard" role="button" data-key="t-add-product"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Klinik Ekle -->
                            <li class="nav-item">
                                <a class="nav-link dropdown-toggle arrow-none" href="ecommerce-customers.php" id="topnav-dashboard" role="button" data-key="t-customers"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Siparil olustur -->
                            <li class="nav-item">
                                <a class="nav-link dropdown-toggle arrow-none" href="ecommerce-orders.php" id="topnav-dashboard" role="button" data-key="t-orders"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Ürünler -->
                            <li class="nav-item">
                                <a class="nav-link dropdown-toggle arrow-none" href="ecommerce-products.php" id="topnav-dashboard" role="button" data-key="t-products"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <!-- make products icon -->
                            ...
                            <div class="d-flex border-bottom align-items-start bg-light">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13"><?php echo $language["Your_task_changed_an_issue_from_In_Progress_to"]; ?><span class="badge badge-soft-success"><?php echo $language["Review"]; ?></span></p>
