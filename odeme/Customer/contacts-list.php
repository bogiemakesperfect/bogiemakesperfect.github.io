...
<head>
    ...
    <title><?php echo $language["User_List"]; ?> | Symox - Admin & Dashboard Template</title>
                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item">
                                                            <a href="javascript:void(0);" class="px-2 text-primary"><i class="bx bx-pencil font-size-18"></i></a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a href="javascript:void(0);" class="px-2 text-danger"><i class="bx bx-trash-alt font-size-18"></i></a>
                                                        </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/images/users/avatar-5.jpg" alt="" class="avatar-sm rounded-circle me-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="assets/images/users/avatar-7.jpg" alt="" class="avatar-sm rounded-circle me-2">
