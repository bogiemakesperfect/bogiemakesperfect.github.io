                            ...
                            <div class="card-body">
                                <div class="text-center py-4">
                                    ...
                                    <div class="main-wid position-relative">
                                        <h3 class="text-white">Viento Müşteri Paneli</h3>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mt-4 mb-0">Müşteriler</p>
                                    <?php
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mt-4 mb-0">Ürünler</p>
                                    <?php
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h3 class="text-black mb-0"> Siparişler</h3>
                            </div>
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-sm-4">
...
$query = "SELECT * FROM viento_siparisler WHERE  siparisler_musterilerid = '$customer_id' ORDER BY siparisler_olusturmatarihi DESC";
